...
const Layout = () => {
  ...
  // Determine active page for better accessibility
  const isActive = (path: string) => location.pathname === path;

  return (
    <div className="d-flex flex-column min-vh-100">
      {/* Skip to main content link - accessibility enhancement */}
      <a href="#main-content" className="visually-hidden-focusable p-2 m-2 bg-light text-dark">
        Skip to main content
      </a>
      
      {/* Header with Brand */}
      <header className="bg-white pt-3 pb-0">
        <Container className="text-center mb-3">
          <Link to="/" className="text-decoration-none">
            <h1 className="mb-0">
              <span style={{ color: 'var(--light-green-1)' }}>Shannon Sternagle</span>{' '}
              <span style={{ color: 'var(--light-blue-1)' }}>Realty</span>
            </h1>
          </Link>
        </Container>
      </header>
          ...
          <Container>
            <div className="nav-tabs-inner">
              <Nav className="nav-tabs" role="navigation" aria-label="Main Navigation">
                ...
                <Nav.Link as={Link} to="/listings" className={`nav-tab ${isActive('/listings') ? 'active' : ''}`} onClick={() => setExpanded(false)} aria-current={isActive('/listings') ? 'page' : undefined}>Listings</Nav.Link>
                <Nav.Link as={Link} to="/sold" className={`nav-tab ${isActive('/sold') ? 'active' : ''}`} onClick={() => setExpanded(false)} aria-current={isActive('/sold') ? 'page' : undefined}>Sold</Nav.Link>
        ...
        <Container>
          <Row>
            ...
            <Col md={4} className="mb-4 mb-md-0">
              ...
              <p className="mb-2">Shannon Sternagle</p>
              <p className="mb-2">Email: shannon@sternaglerealty.com</p>
            ...
            <Col md={4} className="mb-4 mb-md-0">
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-2"><Link to="/listings" className="footer-link">Current Listings</Link></li>
          ...
          <div className="mt-4 pt-4 border-top text-center text-muted small">
            <p>Licensed Realtor in California. All rights reserved. © {new Date().getFullYear()} Shannon Sternagle Realty</p>
          </div>
        </Container>
      </footer>
    </div>
